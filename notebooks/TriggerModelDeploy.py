...
#                            (https://docs.gcp.databricks.com/dev-tools/databricks-utils.html#get-command-dbutilsjobstaskvaluesget),
...
github_repo = dbutils.secrets.get(
    f"{env}-penrose-cd-credentials", "github_repo"
)
token = dbutils.secrets.get(
    f"{env}-penrose-cd-credentials", "token"
)
