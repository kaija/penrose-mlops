...
* [Staging workspace registered model](https://your-staging-workspace.gcp.databricks.com#mlflow/models/staging-penrose-model)
* [Prod workspace registered model](https://6837671528024691.1.gcp.databricks.com#mlflow/models/prod-penrose-model)
