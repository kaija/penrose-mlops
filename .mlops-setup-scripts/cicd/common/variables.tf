...
variable "git_provider" {
  type        = string
  description = "Hosted Git provider, as described in https://docs.gcp.databricks.com/dev-tools/api/latest/gitcredentials.html#operation/create-git-credential. For example, 'gitHub' if using GitHub, or 'azureDevOpsServices' if using Azure DevOps."
}
